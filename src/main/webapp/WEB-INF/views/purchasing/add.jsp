...
<form action="${ctx}/purchasing/create?navTabId=list" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone)">
    <div class="pageContent">
        <div class="pageFormContent" layoutH="97">
            ...
            <dl>
                <dt>日期</dt>
                <dd>
                    <input type="text" name="confirmTime" class="date" dateFmt="yyyy-MM-dd HH:mm" readonly="true"/>
                    <a class="inputDateButton" href="javascript:;">选择</a>
                </dd>
            </dl>
                    ...
                    <div>
                        <table class="list nowrap itemDetail" addButton="新建条目" width="100%">
                            ...
                            <tr>
                                ...
                                <th type="text" name="pds[#index#].goods.width" size="6" defaultVal="0" fieldClass="digits" >净宽/CM</th>
                                <th type="text" name="pds[#index#].orderCount" size="6" defaultVal="0" fieldClass="digits" >单量</th>
                                ...
                                <th type="text" name="pds[#index#].planPurchasingCount" defaultVal="0.0" size="8" fieldClass="number required" >采购计划</th>
                                <th type="text" name="pds[#index#].warehouseCount" defaultVal="0.0" size="8" fieldClass="number" >库存</th>
                                <th type="text" name="pds[#index#].actualPurchasingCount" defaultVal="0.0" size="8" fieldClass="number required" >实需采购</th>
                                <th type="text" name="pds[#index#].specialRequirements" size="20" fieldClass="" >面辅料特殊要求</th>
