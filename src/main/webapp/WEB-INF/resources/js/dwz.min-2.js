...
(function ($) {
    ...
    $.extend({
        bringBackSuggest: function (args) {
            ...
            var input = _lookup['$target'];
            var origin = input.attr("origin");
            if(origin == "true"){
                if(args[_lookup.pk] != ''){
                    input.val(args[_lookup.pk]);
                }
            }else{
    ...
    $.fn.extend({
        ...
        itemDetail: function () {
            ...
            function initSuffix($tbody) {
                $tbody.find('tr.unitBox').each(function (i) {
            ...
            function tdHtml(field) {
                ...
                switch (field.type) {
                    ...
                    case 'suggest':
                        ...
                        html = '<input type="text" origin ="true" name="' + field.name + '"' + suggestFrag + ' lookupPk="' + field.lookupPk + '" size="' + field.size + '" class="' + field.fieldClass + '"/>' ;
                        break;
                    case 'lookup':
                        var suggestFrag = '';
                        if (field.suggestFields) {
